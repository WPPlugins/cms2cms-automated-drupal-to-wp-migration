...
$key = $dataProvider->getOption('cms2cms-drupal-key');
$activated = $dataProvider->isActivated();
$targetUrl = $dataProvider->getSiteUrl();

$authentication = $dataProvider->getAuthData();

$ajaxNonce = $dataProvider->getFormTempKey('cms2cms-drupal-ajax-security-check');
...
$loader = new DrupalCmsBridgeLoader();
try {
...
?>
<div class="wrap cms2cms-drupal-wrapper">
    <div class="cms2cms-drupal-container">
        <div class="cms2cms-drupal-header">
        ...
        <?php if ($activated) { ?>
            <script language="JavaScript">
                jQuery('.cms2cms-drupal-container').addClass('cms2cms_drupal_is_activated');
            </script>
            <div class="cms2cms-drupal-message">
                <span>
                    <?php echo sprintf(
                        $dataProvider->__('You are logged in CMS2CMS as %s', $fileStart),
                        $dataProvider->getOption('cms2cms-drupal-login')
                    ); ?>
                </span>
                <div class="cms2cms-drupal-logout">
                    <form action="" method="post" id="logout" data-logout="<?php echo $dataProvider->getLogOutUrl() ?>">
                        <input type="hidden" name="cms2cms_drupal_logout" value="1"/>
                        <input type="hidden" name="_wpnonce"
                               value="<?php echo $dataProvider->getFormTempKey('cms2cms_drupal_logout') ?>"/>
                        <button class="button-grey cms2cms-drupal-button" data-log-this="Logout" type="button">
        ...
        <?php } ?>
        <div class="cms2cms-drupal-plugin">
            <div id="cms2cms_drupal_accordeon">
                ...
                <?php
                $cms2cms_drupal_step_counter = 1;
                if (!$activated) { ?>
                    <div id="cms2cms_drupal_accordeon_item_id_<?php echo $cms2cms_drupal_step_counter++; ?>"
                         class="step-body cms2cms_drupal_accordeon_item cms2cms_drupal_accordeon_item_register">
                        ...
                        <form action="<?php echo $dataProvider->getLoginUrl() ?>"
                              ...
                              class="step_form"
                              id="cms2cms_drupal_form_register">
                            <div class="center-content">
                                <div class="error_message"></div>
                                <div class="user-name-block" style="display: none">
                                    <label
                                            for="cms2cms-drupal-user-name"><?php $dataProvider->_e('Full Name', $fileStart); ?></label>
                                    <input type="text" maxlength="50" id="cms2cms-drupal-user-name" name="name"
                                           value="" placeholder="Your name" class="regular-text"/>
                                    <div class="cms2cms-drupal-error name">
                                        <div class="error-arrow"></div>
                                        <span></span></div>
                                </div>
                                <div>
                                    <label
                                            for="cms2cms-drupal-user-email"><?php $dataProvider->_e('Email', $fileStart); ?></label>
                                    <input type="text" id="cms2cms-drupal-user-email" name="email"
                                           value="" placeholder="Your email" class="regular-text"/>
                                    <div class="cms2cms-drupal-error email">
                                        <div class="error-arrow"></div>
                                        <span></span></div>
                                </div>
                                <div>
                                    <label
                                            for="cms2cms-drupal-user-password"><?php $dataProvider->_e('Password', $fileStart); ?></label>
                                    <input type="password" id="cms2cms-drupal-user-password" name="password" value=""
                                           placeholder="Your password" class="regular-text"/>
                                    <div class="cms2cms-drupal-error password">
                                        <div class="error-arrow"></div>
                                        <span></span></div>
                                </div>

                                <input type="hidden" id="cms2cms-drupal-user-plugin" name="referrer"
                                       value="<?php echo $dataProvider->getPluginReferrerId(); ?>"
                                       class="regular-text"/>
                                <input type="hidden" id="cms2cms-drupal-site-url" name="siteUrl"
                                ...
                                <button
                                        ...
                                        type="button" id="auth_submit" class="cms2cms-drupal-button button-green">
                                ...
                                <a data-log-this="Forgot Password Link clicked"
                                   ...
                                   class="cms2cms-drupal-real-link" >
                ...
                <?php } /* cms2cms_drupal_is_activated */ ?>
                ...
                <div id="cms2cms_drupal_accordeon_item_id_<?php echo $cms2cms_drupal_step_counter++; ?>"
                     class="step-body cms2cms_drupal_accordeon_item">
                    <?php if (isset($message)) {?>
                        <div class="container-erorr-1">
                            <div class="block-erorr alert r-b-e">
                                <?php $dataProvider->_e(sprintf('%s Please contact our', $message), $fileStart); ?>
                    ...
                    <form action="<?php echo $dataProvider->getWizardUrl(); ?>"
                          method="post"
                          id="cms2cms_drupal_form_estimate">
                        <div class="center-content">
                            <div class="error_message"></div>
                            <div id='error'></div>
                            <p>
                                <a href="<?php echo $dataProvider->getBridgeUrl(); ?>"><?php $dataProvider->_e('Download Bridge', $fileStart); ?> </a> <?php $dataProvider->_e('and upload it to your Drupal site root folder. For more information, please', $fileStart); ?>
                            ...
                            <div>
                                ...
                                <input type="text" id="sourceUrl" name="sourceUrl" value="" class="regular-text"
                                       ...
                                       ?>"/>
                                <div class="cms2cms-drupal-error">
                                    <div class="error-arrow"></div>
                                    <span></span></div>
                            </div>
                            ...
                            <input type="hidden" id="key" name="key"
                                   value="<?php echo $key; ?>"/>
                            <button id="verifySource_drupal"
                                    data-log-this="Verify Source Button pressed"
                                    type="button" name="verify-source" class="cms2cms-drupal-button button-green">
                                <?php $dataProvider->_e('Verify Connection', $fileStart); ?>
                            </button>
                        </div>
                    </form>
                    <div class="cms2cms-drupal-error"></div>
                </div>
            </div>
        </div> <!-- /plugin -->
